 ...
 *
 */
class AuthnetTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.AuthnetTableMap';
     ...
     */
    const OM_CLASS = '\\Authnet';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Authnet';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(AuthnetTableMap::COL_ORDERNBR, AuthnetTableMap::COL_RECTYPE, AuthnetTableMap::COL_DATE, AuthnetTableMap::COL_TIME, AuthnetTableMap::COL_CARDNBR, AuthnetTableMap::COL_TRACK_II, AuthnetTableMap::COL_EXPDATE, AuthnetTableMap::COL_CVV, AuthnetTableMap::COL_TYPE, AuthnetTableMap::COL_AMOUNT, AuthnetTableMap::COL_CARD_NAME, AuthnetTableMap::COL_STREET, AuthnetTableMap::COL_ZIPCODE, AuthnetTableMap::COL_CUSTID, AuthnetTableMap::COL_CUSTPO, AuthnetTableMap::COL_TRANS_ID, AuthnetTableMap::COL_AUTHCODE, AuthnetTableMap::COL_AVS_MSG, AuthnetTableMap::COL_ERROR_CODE, AuthnetTableMap::COL_ERROR_MSG, AuthnetTableMap::COL_RESULT, AuthnetTableMap::COL_TRACK_I, AuthnetTableMap::COL_DUMMY, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(AuthnetTableMap::COL_ORDERNBR => 0, AuthnetTableMap::COL_RECTYPE => 1, AuthnetTableMap::COL_DATE => 2, AuthnetTableMap::COL_TIME => 3, AuthnetTableMap::COL_CARDNBR => 4, AuthnetTableMap::COL_TRACK_II => 5, AuthnetTableMap::COL_EXPDATE => 6, AuthnetTableMap::COL_CVV => 7, AuthnetTableMap::COL_TYPE => 8, AuthnetTableMap::COL_AMOUNT => 9, AuthnetTableMap::COL_CARD_NAME => 10, AuthnetTableMap::COL_STREET => 11, AuthnetTableMap::COL_ZIPCODE => 12, AuthnetTableMap::COL_CUSTID => 13, AuthnetTableMap::COL_CUSTPO => 14, AuthnetTableMap::COL_TRANS_ID => 15, AuthnetTableMap::COL_AUTHCODE => 16, AuthnetTableMap::COL_AVS_MSG => 17, AuthnetTableMap::COL_ERROR_CODE => 18, AuthnetTableMap::COL_ERROR_MSG => 19, AuthnetTableMap::COL_RESULT => 20, AuthnetTableMap::COL_TRACK_I => 21, AuthnetTableMap::COL_DUMMY => 22, ),
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('Authnet');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\Authnet');
        $this->setPackage('');
     ...
     * and findPk*() calls.
     *
     * @param \Authnet $obj A \Authnet object.
     ...
     *
     * @param mixed $value A \Authnet object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Authnet) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Authnet object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        return $withPrefix ? AuthnetTableMap::CLASS_DEFAULT : AuthnetTableMap::OM_CLASS;
    }
     ...
     * @return array           (Authnet object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = AuthnetTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = AuthnetTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + AuthnetTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = AuthnetTableMap::OM_CLASS;
            /** @var Authnet $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            AuthnetTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = AuthnetTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = AuthnetTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(AuthnetTableMap::COL_ORDERNBR);
            $criteria->addSelectColumn(AuthnetTableMap::COL_RECTYPE);
            $criteria->addSelectColumn(AuthnetTableMap::COL_DATE);
            $criteria->addSelectColumn(AuthnetTableMap::COL_TIME);
            $criteria->addSelectColumn(AuthnetTableMap::COL_CARDNBR);
            $criteria->addSelectColumn(AuthnetTableMap::COL_TRACK_II);
            $criteria->addSelectColumn(AuthnetTableMap::COL_EXPDATE);
            $criteria->addSelectColumn(AuthnetTableMap::COL_CVV);
            $criteria->addSelectColumn(AuthnetTableMap::COL_TYPE);
            $criteria->addSelectColumn(AuthnetTableMap::COL_AMOUNT);
            $criteria->addSelectColumn(AuthnetTableMap::COL_CARD_NAME);
            $criteria->addSelectColumn(AuthnetTableMap::COL_STREET);
            $criteria->addSelectColumn(AuthnetTableMap::COL_ZIPCODE);
            $criteria->addSelectColumn(AuthnetTableMap::COL_CUSTID);
            $criteria->addSelectColumn(AuthnetTableMap::COL_CUSTPO);
            $criteria->addSelectColumn(AuthnetTableMap::COL_TRANS_ID);
            $criteria->addSelectColumn(AuthnetTableMap::COL_AUTHCODE);
            $criteria->addSelectColumn(AuthnetTableMap::COL_AVS_MSG);
            $criteria->addSelectColumn(AuthnetTableMap::COL_ERROR_CODE);
            $criteria->addSelectColumn(AuthnetTableMap::COL_ERROR_MSG);
            $criteria->addSelectColumn(AuthnetTableMap::COL_RESULT);
            $criteria->addSelectColumn(AuthnetTableMap::COL_TRACK_I);
            $criteria->addSelectColumn(AuthnetTableMap::COL_DUMMY);
        } else {
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(AuthnetTableMap::DATABASE_NAME)->getTable(AuthnetTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(AuthnetTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(AuthnetTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new AuthnetTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a Authnet or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or Authnet object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Authnet) { // it's a model object
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(AuthnetTableMap::COL_ORDERNBR, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(AuthnetTableMap::COL_RECTYPE, $value[1]));
                $criteria->addOr($criterion);
            }
        }

        $query = AuthnetQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            AuthnetTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                AuthnetTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return AuthnetQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a Authnet or Criteria object.
     *
     * @param mixed               $criteria Criteria or Authnet object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from Authnet object
        }
